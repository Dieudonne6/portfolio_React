// avant ajout fonctionnalité de traduction
// "use client"
...
// Données non-textuelles (liens, statut) : ne dépendent pas de la langue
const projectMeta: Record<string, { links: { demo: string | null; github: string | null } }> = {
  "ProjetLivre API": {
    links: {
      demo: "https://projetlivre-3.onrender.com/api/documentation",
      github: "https://github.com/Dieudonne6/ProjetLivre.git",
  ...
  "ForYou API": { links: { demo: null, github: null } },
  "SchoolBox": { links: { demo: null, github: null } },
  "EcoTrack API": { links: { demo: "#", github: "https://github.com/Dieudonne6/eco_track_api" } },
  "Smart Mobility Analytics": { links: { demo: "#", github: "https://github.com/Dieudonne6/smart_mobility_api" } },
  "GesCom": { links: { demo: "#", github: "https://github.com/Dieudonne6/GestionCommerciale" } },
}
...
export function Projects() {
  ...
  const projects = items.map((item) => ({ ...item, links: projectMeta[item.title]?.links ?? { demo: null, github: null } }))
  ...
  return (
    <section id="projects" className="py-24 bg-card/30">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-primary font-mono text-sm">{t("projects.title")}</span>
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground mt-4">
            {t("projects.subtitle")}
          </h2>
          <div className="w-20 h-1 bg-primary mx-auto mt-4 rounded-full" />
